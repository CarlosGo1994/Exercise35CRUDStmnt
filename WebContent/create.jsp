...
<link rel="stylesheet" href="css/style.css">
		...
		<form class="form-group"action="CreateServlet" method="post">
			...
			<input class="form-control" type="text" id="txtIdProduct" name="txtIdProduct" disabled placeholder="Generated Automatically">
			...
			<input class="btn btn-warning" type="submit" value="Create Product">
